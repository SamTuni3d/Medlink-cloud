    ...
    <div className="space-y-1.5">
      <div className="relative">
        ...
        <input
          ...
          className="h-12 w-full rounded-xl border border-white/10 bg-white/[0.06] pl-10 pr-4 text-sm text-white placeholder:text-white/20 backdrop-blur-sm transition-all duration-200 focus:border-purple-500/60 focus:bg-white/[0.09] focus:shadow-[0_0_0_3px_rgba(147,51,234,0.15)] focus:outline-none"
          {...rest}
        />
      </div>
...
export default function ForgotPasswordPage() {
  ...
  if (sent) {
    return (
      <div className="rounded-[26px] border border-white/[0.09] bg-white/[0.04] p-10 text-center shadow-[0_30px_70px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.09)] backdrop-blur-[48px]">
        <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full border border-purple-500/25 bg-purple-500/10">
        ...
        <Link href="/login"
          className="mt-7 flex h-11 w-full items-center justify-center gap-2 rounded-full border border-white/[0.09] bg-white/[0.04] text-sm font-medium text-white/60 transition-all duration-200 hover:border-purple-500/30 hover:bg-purple-500/10 hover:text-white">
  ...
  return (
    <div className="rounded-[26px] border border-white/[0.09] bg-white/[0.04] p-8 shadow-[0_30px_70px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.09),inset_0_-1px_0_rgba(0,0,0,0.2)] backdrop-blur-[48px]">
      ...
      <div className="mb-7 text-center">
        ...
        <p className="mt-1.5 text-sm text-white/35">Enter your email and we&apos;ll send a reset link</p>
      </div>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4" noValidate>
        <div className="space-y-1">
          ...
          <GlassInput
            icon={Mail} type="email" placeholder="you@pharmacy.com" autoComplete="email"
      ...
      <div className="mt-6">
        <Link href="/login"
          className="flex h-11 w-full items-center justify-center gap-2 rounded-full border border-white/[0.09] bg-white/[0.04] text-sm font-medium text-white/60 transition-all duration-200 hover:border-purple-500/30 hover:bg-purple-500/10 hover:text-white">
          <ArrowLeft className="h-4 w-4" />
          Back to sign in
        </Link>
      </div>
