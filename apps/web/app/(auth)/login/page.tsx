...
/* ── Liquid button ────────────────────────────────────────────────────────── */
function LiquidButton({ children, disabled, type = 'button' }: {
  ...
  return (
    <div>
      ...
      <div className="rounded-[26px] border border-white/[0.09] bg-white/[0.04] p-8 shadow-[0_30px_70px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.09),inset_0_-1px_0_rgba(0,0,0,0.2)] backdrop-blur-[48px]">
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between pl-0.5">
              ...
              <Link
                ...
                className="text-[11px] text-purple-400/70 transition-colors hover:text-purple-300"
                tabIndex={-1}
              >
                Forgot password?
              </Link>
        ...
        <Link
          href="/register"
          className="flex h-11 w-full items-center justify-center rounded-full border border-white/[0.09] bg-white/[0.04] text-sm font-medium text-white/60 transition-all duration-200 hover:border-purple-500/30 hover:bg-purple-500/10 hover:text-white"
        >
        ...
        <div className="grid grid-cols-2 gap-y-2 gap-x-4">
          {[
            ...
            <div key={b} className="flex items-center gap-1.5">
              <CheckCircle2 className="h-3 w-3 shrink-0 text-purple-400/70" />
